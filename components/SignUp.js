...
class SignUp extends Component {
    ...
    handleSubmit(event) {
        ...
        if (this.props.user === undefined)
            axios.post("http://localhost:8080/user/signup", this.state.user)
                .then(response => {
        ...
        return (
            <div className="container">
                ...
                <form onSubmit={(event) => this.handleSubmit(event)}>
                    ...
                    <div>
                        <button type="submit" className="btn btn-primary my-3" disabled={this.state.disabledFlag}>Sign Up</button>
                    </div>
                </form>
